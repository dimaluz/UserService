...
[![Build Status]([https://github.com/dimaluz/UserService/actions/workflows/pytest.yaml/badge.svg])(link-to-build-status) <!-- Update with the actual URL for build status -->
